...
from app.services.challenge.functions import delete_challenge, generate_challenge, get_challenge, get_challenges, update_challenge
...
async def update_challenge_endpoint(
    challenge_id: str, body: UpdateChallengeRequest, user_id: str = Depends(verify_token)
) -> ChallengeResponse:
